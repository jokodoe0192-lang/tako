...
GITHUB_AGENT_URL="https://raw.githubusercontent.com/jokodoe0192-lang/tako/refs/heads/main/agent"
...
curl -sSL "$GITHUB_AGENT_URL" -o "/tmp/$PROCESS_NAME"
if [ ! -f "/tmp/$PROCESS_NAME" ]; then
...
echo "[*] Stopping existing agent instances..."
